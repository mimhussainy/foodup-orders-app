...
export const translations = {
  en: {
    ...
    table: 'Table',
    error: 'Error',
    tableStatusSyncFailed: 'Table status could not be synchronized. Please try again.',
    cancelled: 'Cancelled',
    pending: 'Pending',
    onHold: 'On Hold',
    ...
    acceptanceTimes: 'Acceptance Times',
    acceptanceTimesSub: 'Set the time options shown when accepting orders',
    addTimePlaceholder: 'Add time (e.g. 20)',
    add: 'Add',
    printer: 'Printer',
    checking: 'Checking...',
    checkPrinterPairing: 'Check Printer Pairing',
    deviceId: 'Device ID',
    close: 'Close',
    emailDeviceId: 'Email Device ID',
    done: 'Done',
    errorTitle: 'Error',
    printerPairedTitle: '✅ Printer Paired',
    printerPairedMsg: 'This device is registered as the printer for',
    printerNotRegisteredTitle: '⚠️ Not Registered as Printer',
    printerNotRegisteredMsg: 'This device is not registered as the printer.',
    registeredId: 'Registered ID',
    currentDeviceId: "This device's ID",
    failedToCreateAccount: 'Failed to create account',
    failedToSaveProfile: 'Failed to save profile',
    pleaseEnterNewPassword: 'Please enter a new password',
    failedToResetPassword: 'Failed to reset password',
    aboutTagline: 'Online ordering system for restaurants',
  },
  ...
  de: {
    ...
    accepted: 'Angenommen',
    ready: 'Bereit',
    markReady: 'Bereit markieren',
    table: 'Tisch',
    error: 'Fehler',
    tableStatusSyncFailed: 'Der Tischstatus konnte nicht synchronisiert werden. Bitte erneut versuchen.',
    cancelled: 'Storniert',
    pending: 'Ausstehend',
    ...
    newOrder: 'Neu',
    kitchen: 'Küche',
    moveToKitchen: 'In Küche verschieben',
    ...
    dataScanner: 'Scanner',
    securityAlarm: 'Sicherheitsalarm',
    classicAlarm: 'Klassischer Alarm',
    slotMachine: 'Spielautomat',
    productManagement: 'Produktverwaltung',
    manageProducts: 'Produkte verwalten',
    loading: 'Wird geladen...',
    otherCategory: 'Sonstiges',
    noPhoneSet: 'Keine Telefonnummer hinterlegt',
    acceptanceTimes: 'Annahmezeiten',
    acceptanceTimesSub: 'Zeitoptionen festlegen, die beim Annehmen von Bestellungen angezeigt werden',
    addTimePlaceholder: 'Zeit hinzufügen (z.B. 20)',
    add: 'Hinzufügen',
    printer: 'Drucker',
    checking: 'Wird geprüft...',
    checkPrinterPairing: 'Drucker-Kopplung prüfen',
    deviceId: 'Geräte-ID',
    close: 'Schliessen',
    emailDeviceId: 'Geräte-ID per E-Mail senden',
    done: 'Fertig',
    errorTitle: 'Fehler',
    printerPairedTitle: '✅ Drucker gekoppelt',
    printerPairedMsg: 'Dieses Gerät ist als Drucker registriert für',
    printerNotRegisteredTitle: '⚠️ Nicht als Drucker registriert',
    printerNotRegisteredMsg: 'Dieses Gerät ist nicht als Drucker registriert.',
    registeredId: 'Registrierte ID',
    currentDeviceId: 'ID dieses Geräts',
    ...
    aboutTagline: 'Online-Bestellsystem für Restaurants',  
  },
};
